<script lang="ts">
	...
	function handleGlobalKeyDown(e: KeyboardEvent) {
		// Ctrl+P (Linux/Windows) OR Cmd+P (Mac). The webview runs in a Mac browser
		// too (the host the package extraction was for), where the palette shortcut
		// is the Command key; gating on ctrlKey alone left Mac users unable to open it.

...
import { isPortConfigurable, isContainerNodeType } from './types';
import type {
	NodeInstance,
	Edge,
	ValidationContext,
 ...
 * The field is ready unless it holds the sentinel "__BYOK__" (a key slot was
 * selected but no key entered yet). Empty string (no key required) or any
 * actual key string is ready.
 */

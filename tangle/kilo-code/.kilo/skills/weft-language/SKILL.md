...
the structural rules, fast and local, enforced by the agent's edit loop and
the `tool.execute.after` plugin, and what keeps the graph rendering. [the runtime tier]

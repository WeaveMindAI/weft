...
permission:
  bash:
    "weft test-node * --tier live*": ask
    "weft test-node * --yes*": ask
---
...
1. Read the manual first: `.opencode/skills/weft-node-authoring/SKILL.md` in this project. It is the current anatomy, metadata schema, and Rust pattern, and it beats anything you remember.

...
the structural rules, fast and local, enforced by the agent's edit loop, which
here means running `weft validate` yourself, and what keeps the graph rendering. [the runtime tier]

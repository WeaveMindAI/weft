---
name: weft-grow
description: "COMMAND, not reference: Grow the program one stage at a time against a real input, seeded runs and frozen examples included. Run this when the user asks for this step by name, optionally naming the stage to grow next or an example to check. The sixteen `weft-` reference skills beside it are things you read; this is a procedure you carry out."
---

...
1. Read the manual first: `.cline/skills/weft-node-authoring/SKILL.md` in this project. It is the current anatomy, metadata schema, and Rust pattern, and it beats anything you remember.

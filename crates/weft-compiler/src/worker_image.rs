...
/// (generated by `codegen::emit_warmup_crate` during `build::stage_builder_base_context`).
/// The base Dockerfile COPYs it to `/work` and compiles it into the shared
/// `/weft/target`, precooking the rlibs every worker reuses.
